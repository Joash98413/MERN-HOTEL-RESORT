...
function Sidebar({ setToken })  {
  return (
    <div className='w-[23% min-h-screen border-r-2 border-gray-100 bg-white'>
      ...
      <div className='flex flex-col gap-4 pt-6'>
        ...
        <NavLink to='/list' className='flex items-center gap-3 px-4 py-3 border-b-2 border-gray-200 text-gray-700 hover:bg-fuchsia-500 hover:text-white'>
         <MdFormatListBulletedAdd className='text-[34px] text-black' />
         <p className='hidden md:block text-base'>Room lists</p>
        </NavLink>
        ...
        <NavLink to='/reservation' className='flex items-center gap-3 px-4 py-3 border-b-2 border-gray-200 text-gray-700 hover:bg-fuchsia-500 hover:text-white'>
         < MdChecklistRtl className='text-[34px] text-black'/>
         <p className='hidden md:block text-base'>Reservations</p>
        </NavLink>
        
        <button onClick={()=> setToken("")} className='flex-center gap-3 px-6 py-3 border-b-2 border-gray-200 text-gray-600 hover:bg-fuchsia-500 w-full text-left'>
           <IoIosLogOut className='text-[34px] text-black'/>
